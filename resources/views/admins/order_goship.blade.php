...
<body>
            ...
            <div id="mws-navigation">
                <ul>            
                    <li>
                        ...
                        <ul class='closed'>
                            <!-- <li><a href="/admin/order/goship"><i class="icol32-package-link"></i>&nbsp;&nbsp;订单发货</a></li> -->
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                ...
                <div class="mws-panel-body no-padding">
                    <form class="mws-form" action="goship" method="post">
    ...
    <!-- Core Script -->
    <script src="/ad日mins/bootstrap/js/bootstrap.min.js"></script>
