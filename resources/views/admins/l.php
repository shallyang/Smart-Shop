...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：网站配置</td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="get" action="/admin/webconfig/webconfig">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="webkeywords" value="" class="text-word" placeholder="请输入关键字">
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="webdescript" value="" class="text-word" placeholder="请输入描述信息">
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="webcopyright" value="" class="text-word" placeholder="用正斜线/分割开">
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <label><input type="radio" name="webopen" value="开启" checked="checked">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
		<label><input type="radio" name="webopen" value="关闭" >关闭</label>
        
        <!--  单选框的获取和设置
         获取默认选中的值 -->
        <script type="text/javascript">
            var sexs = $('input[name=webopen]');
            //遍历数组对象
            sexs.each(function(){
            ...
            $('input[name=sex][value=开]').attr('checked',true);
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="file" name="thumbnial" value="" >
        </td>
      </tr>
