...
@section('content')
        ...
        <div class="mws-panel-body no-padding">
            ...
            <label>搜索: <input type="text" aria-controls="DataTables_Table_1" name="search" placeholder="请输入要搜索的内容">
            <button>开始</button>
            </form>
            </label></div>
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                <thead>
                    ...
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 90px;">用户状态</th>
                     <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 50px;">用户等级</th>
            ...
            <tbody role="alert" aria-live="polite" aria-relevant="all">
                ...
                @endforeach
                  ...
                  <div class="dataTables_paginate paging_full_numbers" id="DataTables_Table_1_paginate"> {!! $row->render() !!}</div></div>
                </div>
                </div>
            </div>
@endsection
